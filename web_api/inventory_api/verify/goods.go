...
type GoodsForm struct {
	...
	ShipFree    int32    `form:"ship_free" json:"ship_free" binding:"required"`
...
type GoodsStatusForm struct {
	IsNew  int32 `form:"new" json:"new" binding:"required"`
	IsHot  int32 `form:"hot" json:"hot" binding:"required"`
	OnSale int32 `form:"sale" json:"sale" binding:"required"`
}
