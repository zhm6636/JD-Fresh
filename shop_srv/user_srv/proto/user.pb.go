...
func (x *CreateUserInfo) GetBirthday() *timestamp.Timestamp {
	if x != nil {
		return x.Birthday
	}
	return nil
...
var file_user_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0f, 0x74, 0x69,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x98, 0x01,
	...
	0x62, 0x69, 0x72, 0x74, 0x68, 0x64, 0x61, 0x79, 0x22, 0x27, 0x0a, 0x0d, 0x4d, 0x6f, 0x62, 0x69,
	...
	0x6e, 0x64, 0x65, 0x72, 0x12, 0x1a, 0x0a, 0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x79,
	...
	0x70, 0x74, 0x79, 0x32, 0xa5, 0x02, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2b, 0x0a, 0x0b,
...
var file_user_proto_depIdxs = []int32{
	...
	10, // 1: CreateUserInfo.birthday:type_name -> google.protobuf.Timestamp
	0,  // 2: User.GetUserList:input_type -> PageInfo
	4,  // 3: User.GetUserByMobile:input_type -> MobileRequest
	5,  // 4: User.GetUserById:input_type -> IdRequest
	3,  // 5: User.CreateUser:input_type -> CreateUserInfo
	6,  // 6: User.UpdateUser:input_type -> UpdateUserInfo
	7,  // 7: User.CheckPassWord:input_type -> PasswordCheckInfo
	2,  // 8: User.GetUserList:output_type -> UserListResponse
	1,  // 9: User.GetUserByMobile:output_type -> UserInfoResponse
	1,  // 10: User.GetUserById:output_type -> UserInfoResponse
	1,  // 11: User.CreateUser:output_type -> UserInfoResponse
	9,  // 12: User.UpdateUser:output_type -> Empty
	8,  // 13: User.CheckPassWord:output_type -> CheckResponse
